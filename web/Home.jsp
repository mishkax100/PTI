<%-- 
    Document   : Home
    Created on : Jun 15, 2017, 4:48:49 PM
    Author     : Hp i3 Geforce
--%>

<%@page import="model.Karya_ilmiah"%>
<%@page import="control.*"%>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>Pengunjung</p>
            <a href="#"><em class="fa fa-circle text-success"></em> online</a></div>
          </div>
          <!-- search form -->
          <!-- /.search form -->
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="#"><em class="fa fa-circle-o text-green"></em> Login</a></li>
            <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> Sign Up</a></li>
              ...
              <div class="col-md-3">
                ...
                <div class="box-body">
                  ...
                  <tbody role="alert" aria-live="polite" aria-relevant="all">
                    <% 
List<Karya_ilmiah> list=ControlKaryaIlmiah.lihatKaryaIlmiah();
